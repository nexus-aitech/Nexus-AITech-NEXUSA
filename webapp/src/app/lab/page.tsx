...
import { Timer, CheckCircle2, Loader2, ChevronRight, ChevronLeft, RefreshCcw, Flag, AlertCircle } from "lucide-react";
...
// Example fallback quiz if API is not reachable
const FALLBACK_QUIZ = {
  ...
  questions: [
    {
      id: "q1",
      type: "single",
      title: "What is the total supply of Bitcoin (BTC)?",
      options: [
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-muted px-4 py-8">
        <Card className="max-w-lg w-full text-center p-6">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Answers have been submitted for evaluation.</p>
      ...
      <Card className="max-w-2xl w-full shadow-md">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground pt-2">
            <AlertCircle className="h-3.5 w-3.5"/> Timer enforced. Quiz will auto-submit when time expires.
            <Flag className="h-3.5 w-3.5 ml-3"/> Flag questions for later review (future feature).
          </div>
        </CardContent>
      </Card>
    </div>
